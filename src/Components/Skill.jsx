...
function Skill({ sm, md, xl, img, alt, pad, level, extra_tags}) {
    ...
    return <div className={`col d-flex flex-row justify-content-center align-items-center pb-3 mb-3 ` + extra_tags} data-toggle="tooltip" data-placement="right" title={alt}>
